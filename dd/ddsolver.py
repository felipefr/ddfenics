...
class DDSolver:
    ...
    def distance_relative(self):
        ...
        # return self.metric.dist_energy_fenics(self.problem.z_mech, self.problem.z_db)/self.norm_ref() # not working in ddfenicsx
        return self.metric.dist_fenics(self.problem.z_mech, self.problem.z_db)/self.norm_ref()
